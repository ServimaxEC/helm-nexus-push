...
## Installation
  ...
  * `helm plugin install --version master https://github.com/ServimaxEC/helm-nexus-push.git`
...
## Usage
  ...
  * `helm nexus-push . mychart-0.0.1-release.tgz` send publish to https://cf1hlmnxs.servimaxec.com/repository/helm-releases/
  * `helm nexus-push . mychart-0.0.1-snapshot.tgz` send publish to https://cf1hlmnxs.servimaxec.com/repository/helm-snapshots/
  * `helm nexus-push . ./mychart` version chart 0.0.1-release send publish to https://cf1hlmnxs.servimaxec.com/repository/helm-releases/
  * `helm nexus-push . ./mychart` version chart 0.0.1-snapshot send publish to https://cf1hlmnxs.servimaxec.com/repository/helm-snapshots/
